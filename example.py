...
# CHECKIN_EX : list = ["<STX>","<SEP>",il_station,"<SEP>","CX","<SEP>",room_number,"<SEP>", date_from ,"<SEP>",time_from, "<SEP>", date_to, "<SEP>",time_to,"<SEP>","<ETX>","<LRC>"] #CHECKIN_EX
# COPYCARD : list = [f"<STX>","<SEP>",il_station,"<SEP>","CG","<SEP>",room_number,"<SEP>",date_from,"<SEP>",time_from,"<SEP>",date_to,"<SEP>",time_to,"<SEP>","<SEP>","<SEP>","RP","<SEP>","Reception","<SEP>","<SEP>","<SEP>","""EmMarine::keep,starttime::{time_from},room::{room_number},startdate::{date_from},service::0,enddate::{date_to},description::custom door,typeid::4,place::0,guest_card_version::{card_version},endtime::{time_to}""","<SEP>","<ETX>"] #COPYCARD
# EMERGENCYCARD : list = ["<STX>","<SEP>",il_station,"<SEP>","EM","<SEP>",room_number,"<SEP>",start_date,"<SEP>",start_time,"<SEP>",end_date,"<SEP>",end_time,"<SEP>","<ETX>","<LRC>"] #EMERGENCYCARD
# USAGE EXAMPLE
